...
author:
  - name: Jeremy Selva [{{< fa solid link >}}](https://jeremy-selva.netlify.app/) [{{< fa brands github >}}](https://github.com/JauntyJJS) [{{< fa brands linkedin >}}](https://www.linkedin.com/in/jeremy-selva-085b9112a) [{{< fa brands twitter >}}](https://twitter.com/jauntyjjs) 
...
We read the transition's peak area measurement using Reversed-Phase UltraHigh-Performance Liquid Chromatography/ Mass Spectrometry (RP-UHPLC)/MS). The measurement is done by lab 3 during Phase II of the project.
...
plot_raincloud_plotly <- function(raincloud_data,
                                  ...
                                  legend_category_var = "QC_Sample_Type",
                                  legend_title = "",
                                  annotation_var = c("Injection_Sequence",
                                                     "Area",
                                                     "QC_Sample_Type"),
                                  show_y_axis_title = FALSE,
                                  show_legend = TRUE) {
...
Unfortunately, the trellis plot does not seems to function properly in the Quarto document. As such, the code below is called interactive via the console.
